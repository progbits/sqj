...
sqjson: src/main.c src/json_tokenize.c src/json_parse.c src/json_schema.c src/json_virtual_table.c src/util.c
	@mkdir -p bin
	clang -g -O3 -lsqlite3 -o bin/$(BINARY) src/main.c src/json_tokenize.c src/json_parse.c src/json_schema.c src/json_virtual_table.c src/util.c
